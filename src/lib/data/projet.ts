...
// Importe tes autres images ici pour la galerie
// import alice1 from '$lib/assets/alice-1.png';
// import sportiz1 from '$lib/assets/sportiz-1.png';
...
export interface Project {
    ...
    alt: string;
    link: string;
    year: string; // Nouvelle donnée
    tools: string[]; // Nouvelle donnée
    gallery: string[]; // Nouvelle donnée pour les images supplémentaires
}
...
export const projects: Project[] = [
    {
        ...
        link: "https://ton-lien.com/aliceguy",
        year: "2023",
        tools: ["HTML", "SASS", "JavaScript", "GSAP", "Phaser.js", "PHP", "React"],
        // Remplace 'aliceGuy' par tes vraies images importées
    ...
    },
    {
        ...
        // Remplace 'sportiz' par tes vraies images importées
